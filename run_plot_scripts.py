...
if __name__ == "__main__":
    scripts = [
        "scripts/script_iterable_scan.py --datafile Clustering_Efficiency --config hd_1x2x6_centralAPA --name marley_official -v Purity --iterables '#Hits' -y Density --labely 'Density' --logy",
        "scripts/script_iterable_scan.py --datafile Clustering_Efficiency --config hd_1x2x6_centralAPA --name marley_official -v Completeness --iterables '#Hits' -y Density --labely 'Density' --logy",
        "scripts/script_iterable_scan.py --datafile Preselection_Efficiency --config hd_1x2x6 vd_1x8x14_3view_30deg --name marley_official -v SignalParticleK --iterables '#Hits' -y Efficiency --labely 'Efficiency (%)' --connect",
        ...
        "scripts/script_iterable_scan.py --datafile Adjacent_Cluster_Distributions --configs vd_1x8x14_3view_30deg_nominal --name marley_official -v AdjClMainE -y Counts --iterables Signal --labelx 'True Particle Energy (MeV)' --labely 'Counts per Event' --logx --logy",
        "scripts/script_iterable_scan.py --datafile Adjacent_Cluster_Distributions --configs vd_1x8x14_3view_30deg_shielded --name marley -v AdjClMainE -y Counts --iterables Signal --labelx 'True Particle Energy (MeV)' --labely 'Counts per Event' --logx --logy",
        "scripts/script_iterable_scan.py --datafile Cumulative_Vertex_Error --name marley_official -y Sample -x Values --iterables Energy -v X Y Z --labelx 'Vertex Error (cm)' --labely 'Sample Size (%)' --logx",
        "scripts/script_iterable_scan.py --datafile TPC_Cluster_Efficiency_Drift_Scan  --name marley_official --config vd_1x8x14_3view_30deg -y Efficiency -x Coordinate -v X --iterables Energy --connect --labelx 'Drift Coordinate (cm)' --labely 'Efficiency (%)'",
        "scripts/script_iterable_scan.py --datafile TPC_Cluster_Efficiency_Energy_Scan --name marley_official --config vd_1x8x14_3view_30deg -y Efficiency -x Energy -v X --iterables Coordinate  --connect --labelx 'True Neutrino Energy (MeV)' --labely 'Efficiency (%)'",
        "scripts/script_iterable_scan.py --datafile TPC_Cluster_Efficiency_Plane_Scan  --name marley_official --config vd_1x8x14_3view_30deg -y Efficiency -x Coordinate --iterables Plane -v X Y Z --connect --labelx 'Coordinate (cm)' --labely 'Efficiency (%)'",
        ...
        "scripts/script_compare_hist2d.py --datafile Charge_Lifetime_Correction -x Time -y ChargePerEnergy -c Corrected -i '#Hits' -s 3.0 nan --logz --zoom",
        ...
        "scripts/script_configuration_comparison.py --datafile Fiducial_Efficiency -y Efficiency --variables X Y Z -i Energy Inverse Reference -s 6 'False' Truth --labelx 'Fiducial Cut (cm)' --labely 'Reconstruction Efficiency (%)'",
        "scripts/script_configuration_comparison.py --datafile Fiducial_Efficiency -y Efficiency --variables X Y Z -i Energy Inverse Reference -s 10 'False' Truth --labelx 'Fiducial Cut (cm)' --labely 'Reconstruction Efficiency (%)'",
        "scripts/script_configuration_comparison.py --datafile Fiducial_Efficiency -y Efficiency --variables X Y Z -i Energy Inverse Reference -s 14 'False' Truth --labelx 'Fiducial Cut (cm)' --labely 'Reconstruction Efficiency (%)'",
        "scripts/script_configuration_comparison.py --datafile Fiducial_Efficiency -y Efficiency --variables X Y Z -i Energy Inverse Reference -s nan 'False' Truth --labelx 'Fiducial Cut (cm)' --labely 'Reconstruction Efficiency (%)'",
