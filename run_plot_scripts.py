...
if __name__ == "__main__":
    scripts = [
        "scripts/script_iterable_scan.py --datafile Clustering_Efficiency --config hd_1x2x6_lateralAPA vd_1x8x14_3view_30deg_nominal --name marley_official -v Purity --iterables '#Hits' -y Density --labely 'Density' --logy",
        "scripts/script_iterable_scan.py --datafile Clustering_Efficiency --config hd_1x2x6_lateralAPA vd_1x8x14_3view_30deg_nominal --name marley_official -v Completeness --iterables '#Hits' -y Density --labely 'Density' --logy",
        ...
        "scripts/script_iterable_scan.py --datafile NHit_Distributions --config hd_1x2x6 --name marley_official -v ElectronK --iterables '#Hits'",
        ...
        "scripts/script_iterable_scan.py --datafile Adjacent_Cluster_Distributions --config vd_1x8x14_3view_30deg_shielded --name marley -v AdjClMainE -y Counts --iterables Signal --labelx 'True Particle Energy (MeV)' --labely 'Counts per Event' --logx --logy",
        ...
        "scripts/script_configuration_comparison.py --datafile Fiducial_Efficiency -y Efficiency --variables X Y Z -i Energy Inverse Reference -s   6 'False' Reco --labelx 'Fiducial Cut (cm)' --labely 'Reconstruction Efficiency (%)'",
        "scripts/script_configuration_comparison.py --datafile Fiducial_Efficiency -y Efficiency --variables X Y Z -i Energy Inverse Reference -s  10 'False' Reco --labelx 'Fiducial Cut (cm)' --labely 'Reconstruction Efficiency (%)'",
        "scripts/script_configuration_comparison.py --datafile Fiducial_Efficiency -y Efficiency --variables X Y Z -i Energy Inverse Reference -s  14 'False' Reco --labelx 'Fiducial Cut (cm)' --labely 'Reconstruction Efficiency (%)'",
        "scripts/script_configuration_comparison.py --datafile Fiducial_Efficiency -y Efficiency --variables X Y Z -i Energy Inverse Reference -s nan 'False' Reco --labelx 'Fiducial Cut (cm)' --labely 'Reconstruction Efficiency (%)'",
