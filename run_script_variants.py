...
if __name__ == "__main__":
    scripts = [
        ...
        "scripts/script_configuration_comparison.py --datafile Electron_Energy_Resolution -y RMS -e Clustering Drift '#Hits' --labelx 'True Neutrino Energy (MeV)' --labely 'RMS (True - Reco) / True'",
        "scripts/script_configuration_comparison.py --datafile Neutrino_Energy_Resolution -y RMS -v TotalEnergy SelectedEnergy -e Drift '#Hits' --labelx 'True Neutrino Energy (MeV)' --labely 'RMS (True - Reco) / True'",
    ]
